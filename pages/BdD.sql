...
insert into membre(email, motdepasse, nom, datenaissance) values('test@tay.com','tayBleTP','Atest','2000-01-04');
insert into membre(email, motdepasse, nom, datenaissance) values('test1@tay.com','1tayBleTP','Btest','2001-01-04');
insert into membre(email, motdepasse, nom, datenaissance) values('test2@tay.com','2tayBleTP','Ctest','2002-01-04');

insert into amis values ('1','2','2018-02-17','2018-02-19');
insert into amis values ('2','3','2018-02-11','2018-02-17');
insert into amis values ('3','1','2018-02-07','2018-02-17');
